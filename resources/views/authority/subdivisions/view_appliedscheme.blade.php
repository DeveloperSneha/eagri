...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        {!! Form::open(['url' => 'authority/subdivisions/apprejectscheme','class'=>'form-horizontal']) !!}
        ...
        <div class="form-group">
            {!! Form::label('Remarks OF '.$app_reject_scheme->designation->designationName, null, ['class' => 'col-sm-4 control-label required']) !!}
            <div class="col-sm-6">
