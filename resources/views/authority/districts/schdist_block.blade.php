                    ...
                    $('#idBlock').empty();
                       $.each(data, function(key, value) {
                            ...
                            var checkbox="<tr>\n\
                                                ...
                                                <td><input type = 'text' name='blocks["+key+"][areaBlock]'  onchange='getArea("+key+")' id='areablock"+key+"' class='form-control' ><span id='errorarea"+key+"' class='help-block'></span><input type='hidden' id='hiddenarea"+key+"'></td>\n\
                                                <td><input type = 'text' name='blocks["+key+"][amountBlock]' id='amtblock"+key+"' class='form-control'><span id='erroramt"+key+"' class='help-block'></span><input type='hidden' id='hiddenamount"+key+"'></td>\n\
                                            </tr>"
